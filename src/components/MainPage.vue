...
@nerissasunit2k 
1
03monica835/FinalProject
 Code Issues 0 Pull requests 0 Actions Projects 0 Wiki Security Insights
FinalProject/src/components/MainPage.vue
@Gracejean Gracejean dasfdA
8c0d008 yesterday
@monica835@chloe868@romeo-art@Gracejean@jorgielyn
390 lines (390 sloc)  10.5 KB
      ...
      <v-container>
        <v-row justify="space-between">
          ...
          <v-col class="col=6">
            ...
            <v-btn class="primary" @click="reserved(items._id)">Reserved</v-btn>
          </v-col>
        </v-row>
      </v-container>
    </v-card>
